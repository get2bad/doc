...
一整套大数据的组件几乎都学完了，但是还是没有办法进行融会贯通，因为以后的趋势是走实时计算，所以自己并不是很想去弄离线计算

花了500块买了个实战课，自己跟着学一下吧，后续会重学一遍shell编程，外加学一下python，后续就着重开始弄实时数仓方向的东西了，时间没那么多了
...
2021-05-14 力扣LeetCode 每日一题 [罗马文[<font color=orange>中等</font>]](./docs/算法/罗马文问题.md)
